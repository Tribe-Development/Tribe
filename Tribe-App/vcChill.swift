...
class vcChill: UIViewController {
    ...
    func toMoney(){
        performSegueWithIdentifier("chillToMoney", sender: self)
    }
    
    func toSettings(){
        performSegueWithIdentifier("chillToSettings", sender: self)
    }
    ...
    func toMessage(){
        performSegueWithIdentifier("chillToMessage", sender: self)
    }
