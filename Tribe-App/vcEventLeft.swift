...
class vcEventLeft: UIViewController {
    ...
    func toChill(){
        performSegueWithIdentifier("eventLeftToChill", sender: self)
    }
    
    func toSettings(){
        performSegueWithIdentifier("eventLeftToSettings", sender: self)
    }
    
    func toMoney(){
        performSegueWithIdentifier("eventLeftToMoney", sender: self)
    }
    
    func toMessage(){
        performSegueWithIdentifier("eventLeftToMessage", sender: self)
    }
    ...
    func respondToSwipeGesture(gesture: UIGestureRecognizer) {
        if let swipeGesture = gesture as? UISwipeGestureRecognizer {
            ...
            case UISwipeGestureRecognizerDirection.Left:
                performSegueWithIdentifier("eventLeftToEvent", sender: self)
            default:
                break
            }
        }
