...
class vcSettings: UIViewController {
    ...
    func toMoney(){
        performSegueWithIdentifier("settingsToMoney", sender: self)
    }
    
    func toChill(){
        performSegueWithIdentifier("settingsToChill", sender: self)
    }
    ...
    func toMessage(){
        performSegueWithIdentifier("settingsToMessage", sender: self)
    }
