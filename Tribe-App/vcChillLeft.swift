...
class vcChillLeft: UIViewController {
    ...
    func toMoney(){
        performSegueWithIdentifier("chillLeftToMoney", sender: self)
    }
    
    func toSettings(){
        performSegueWithIdentifier("chillLeftToSettings", sender: self)
    }
    ...
    func toMessage(){
        performSegueWithIdentifier("chillLeftToMessage", sender: self)
    }
    ...
    func respondToSwipeGesture(gesture: UIGestureRecognizer) {
        ...
        if let swipeGesture = gesture as? UISwipeGestureRecognizer {
            ...
            case UISwipeGestureRecognizerDirection.Left:
                performSegueWithIdentifier("chillLeftToChill", sender: self)
            default:
                break
            }
        }
